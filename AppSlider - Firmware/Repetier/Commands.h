...
#ifdef SHOOT_SUPPORT
    static uint32_t getDelayTime(GCode *com);
    static void pause(uint32_t delayTime);
    static void camShot(float startVerzoegerung, long fokusTime, long shootTime, float nachgeschalteteVerzoegerung, bool isFokusShootSame);
#endif
private:
