...
/**************** READ FIRST 2 ************************
  Here are some inofficial enhancements included by Kevin Tuncer to make this version shoot move shoot capable. 
  These extensions are always included with the condition "#ifdef SHOOT_SUPPORT".
...
#define UI_PRINTER_NAME "Kameraführung"
#define UI_PRINTER_COMPANY "Ich"
...
========== Start configuration string ==========
{
    ...
    "featureController": 0,
    "uiPrinterName": "Kameraf\u00fchrung",
    "uiPrinterCompany": "Ich",
