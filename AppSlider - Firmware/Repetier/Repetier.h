...
#define GCODE_BUFFER_SIZE 2 //- war vorher auf 1, nun mit 2 gilt der Notstopp immer sofort ansonsten müsste void GCode::readFromSerial(){ if(bufferLength >= GCODE_BUFFER_SIZE) return; .. } die if-Bedingung umgangen werden  
